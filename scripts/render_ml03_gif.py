#!/usr/bin/env python3
"""Record assets/ml03.gif: same scripted route as ml02 (fragile mirrors differ in-game)."""
...
def main() -> None:
    ...
    env = arc.make(full_game_id_for_stem("ml03"), seed=0, include_frame_data=True)
    obs = env.reset()
