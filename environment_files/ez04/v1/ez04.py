...
class Ez04UI(RenderableUserDisplay):
...
levels = [
    Level(
        sprites=[
            sprites["player"].clone().set_position(3, 1),
    ...
    Level(
        sprites=[
            ...
            sprites["target"].clone().set_position(4, 5),
        ],
        grid_size=(8, 8),
        data={"difficulty": 2},
    ),
    Level(
        sprites=[
            ...
            sprites["target"].clone().set_position(3, 6),
        ],
        grid_size=(8, 8),
        data={"difficulty": 3},
    ),
