...
class Wm02UI(RenderableUserDisplay):
    def __init__(
...
class Wm02(ARCBaseGame):
    """Lane moles: each spawn picks a fixed lane (column band); whack only in that lane. Clicking another lane while a mole is up costs a life."""

    def __init__(self) -> None:
        self._ui = Wm02UI(5, 0, 0, 3)
