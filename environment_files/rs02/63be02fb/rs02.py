...
class Rs02UI(RenderableUserDisplay):
    """HUD: dual safe colors + pair index + targets."""
...
class Rs02(ARCBaseGame):
    """Dual safe colors: collect targets matching either color of the active pair."""
    ...
    def step(self) -> None:
        ...
        if len(self._targets) == 0:
            self._win_hold = Rs02.WIN_HOLD_FRAMES
