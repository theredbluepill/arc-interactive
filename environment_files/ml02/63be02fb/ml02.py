...
levels = [
    ...
    # L2 — column wall x=11 + gap at (11,12) (row split looked like a gap but blocked east rays).
    mk(
        (24, 24),
    ...
    # L4 — different column gap (x=14); dual receptors on row 12 (no mirrors).
    mk(
        (24, 24),
    ...
    # L5 — column wall x=16 + gap; emitter further right than L1/L2/L4.
    mk(
        (24, 24),
