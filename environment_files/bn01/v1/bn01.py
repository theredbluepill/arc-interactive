"""Beacon sweep: hidden targets lie under the fog. ACTION5 places a beacon at the player (budget) to reveal nearby cells; ACTION6 flags a cell as a target guess. Wrong flag loses; flag all hidden cells to win."""
