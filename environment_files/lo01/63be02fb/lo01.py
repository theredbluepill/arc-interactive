"""Lights Out: ACTION6 clicks toggle a cell and its four neighbors; turn all lights off. ACTION1–4 are no-ops."""
...
class Lo01UI(RenderableUserDisplay):
    ...
    def set_click(self, frame_x: int, frame_y: int) -> None:
        ...
        self._click_frames = Lo01UI.CLICK_ANIM_FRAMES
    ...
    def render_interface(self, frame):
        ...
        if self._click_pos and self._click_frames > 0:
            ...
            phase = Lo01UI.CLICK_ANIM_FRAMES - self._click_frames
            if phase < 6:
...
# Each level is a grid-corner “L” (three ON cells); one click on the corner clears that L
# without lighting a fourth in-bounds cell (corners only, not edge-centers on small grids).
levels = [
    mk([(0, 0), (1, 0), (0, 1)], [], (3, 3), 1),
    mk([(2, 0), (1, 0), (2, 1)], [], (3, 3), 2),
    mk([(2, 2), (1, 2), (2, 1)], [], (3, 3), 3),
    mk([(0, 0), (1, 0), (0, 1)], [], (5, 5), 4),
    mk([(0, 0), (1, 0), (0, 1), (4, 4), (3, 4), (4, 3)], [], (5, 5), 5),
]


class Lo01(ARCBaseGame):
