"""Circuit stitch: connect the cyan input to the yellow output with orange wire tiles. ACTION6 toggles wire on a cell; ACTION5 checks connectivity (win when the output is reached from the input through wires)."""
...
levels = [
    ...
    mk([(12, y) for y in range(24) if y != 12], (6, 12), (18, 12), 50, 2),
...
class Ck01(ARCBaseGame):
    ...
    def _reachable(self) -> bool:
        ...
        def try_add(nx: int, ny: int) -> bool:
