"""Torus Lights Out: ACTION6 toggles a cell and its four orthogonal neighbors with wrap-around on grid edges. Walls block toggles. ACTION1–4 no-op."""
...
class Lo02UI(RenderableUserDisplay):
    ...
    def set_click(self, frame_x: int, frame_y: int) -> None:
        ...
        self._click_frames = Lo02UI.CLICK_ANIM_FRAMES
