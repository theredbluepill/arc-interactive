...
| ll01 | Simulation | 32×32 | 5 | **Generations lock**: Conway Life; **ACTION6** toggles cells (budget); **ACTION5** advances one generation; after exactly **N** steps the live set must equal the target. Levels use **2×2 still-life** targets (stable blocks). | ![ll01](assets/ll01.gif) | • 1–4: No-op • 5: Step CA • 6: Toggle cell |
